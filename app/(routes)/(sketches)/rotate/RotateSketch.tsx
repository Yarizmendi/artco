...
//       imagesArr = familyImages.map( img => p5.loadImage(`images/${ img.path }`))
//       Noise = p5.loadImage(`images/${ noiseTextures[0].path }`)
...
//       if ( timer < imgChangeTime ) {
//         Shader.setUniform( "u_foreground", imagesArr[ imgIdx + 1 ]) 
//         Shader.setUniform( "u_background",  imagesArr[ imgIdx ])
//       }
//       else if ( imagesArr.length-2 > imgIdx ) {
//         imgChangeTime+=15
//         imgIdx+=1
//         Shader.setUniform( "u_timeout", p5.millis() )
//       } 
