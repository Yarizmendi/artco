...
import { UseNotes } from "@/api/vercel/notes/UseNotes"
import { ImageCreateForm } from "@/comps/Forms/ImageCreateForm"
import { Painting } from "@/comps/Links/PaintingLink"
import { Loading } from "@/comps/Loading"
import { NotFound } from "@/comps/NotFound"

export default function NotesList({ uploaderId }) {
  const { data, error, isLoading, isValidating, mutate } = UseNotes({ uploaderId })
  ...
  if ( data ) return (
    <div className="w-full h-full flex flex-col items-center justify-center md:flex-row md:items-start m-2 p-2 gap-2">
      ...
      <div className="w-11/12 md:w-1/3 m-4 md:my-10">
