...
import { loginUserAction } from "actions/users/getUserAction"
          ...
          <form action={loginUserAction}>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                ...
                <label htmlFor="remember" className="ml-2 block text-sm dark:text-white">Remember me</label>
              </div>
              <a href="#" className="text-sm text-blue-600 hover:text-blue-500">Forgot password?</a>
            </div> 
            <div>
              <button type="submit" className="w-full bg-blue-700 text-white rounded-md py-2 px-4 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">{"Login"}</button>
            </div> 
          </form>
        </div>
